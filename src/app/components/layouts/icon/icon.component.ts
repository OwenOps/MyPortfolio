...
@switch (name) {
  @case ('github') {
    <a href="https://github.com/OwenOps" class="social-media__link github" target="_blank">
  ...
  @case ('linkedin') {
    <a href="https://www.linkedin.com/in/owen-rebeller" class="social-media__link linkedin"
      target="_blank">
  ...
  @case ('steam') {
    <a href="https://steamcommunity.com/profiles/76561198857582544" class="social-media__link steam"
      target="_blank">
      <img src="assets/img/steam.png" alt="steam-valve" width="31px">
    </a>
  }
  @case ('instagram') {
    <a href="https://www.instagram.com/je_sappelle_owen/" class="social-media__link instagram"
      target="_blank">
  ...
  @case ('email') {
    <a class="social-media__link email" (click)="copyEmail()" style="cursor: pointer;">
    ...
    @case ('phone') {
      <a class="social-media__link phone" (click)="copyPhone()" style="cursor: pointer;">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="size-6">
          <path stroke-linecap="round" stroke-linejoin="round"
      ...
      @case ('address') {
        <a class="social-media__link address" (click)="copyLocation()" style="cursor: pointer;" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round"
